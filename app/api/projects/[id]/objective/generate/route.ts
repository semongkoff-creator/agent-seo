...
import { objectiveGenerationSchema, objectiveInputParamsSchema } from '@/lib/validators/objectives';
...
export async function POST(request: Request, { params }: Params) {
  try {
    ...
    const input = await parseJsonBody(request, objectiveGenerationSchema);
